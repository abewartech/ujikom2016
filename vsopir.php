...
<thead>
    ...
    echo"<tr>
            <td>$r[Id_Sopir]</td>
            <td>$r[Nama_Sopir]</td>
			<td>$r[Alamat_Sopir]</td>
            <td>$r[Telp_Sopir]</td>
			<td>$r[No_SIM]</td>
            <td>$r[Tarif_Per_Jam]</td>
			<td><a href='dsopir.php?IdSopir=".$r['IdSopir']."' class='delete'>Hapus |<a/>
			<a href='esopir.php?IdSopir=".$r['IdSopir']."' class='delete'>Edit<a/>
			</td>
        </tr>";
		$no++;	
	}
