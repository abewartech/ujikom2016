...
<thead>
    ...
    echo"<tr>
			...
			<td>$r[Telp_Pelanggan]</td>
			<td><a href='dpelanggan.php?NoKTP=".$r['NoKTP']."' class='delete'>Hapus |<a/>
			<a href='epelanggan.php?NoKTP=".$r['NoKTP']."' class='delete'>Edit<a/>
			</td>
        </tr>";
		$no++;	
	}
