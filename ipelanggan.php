...
<div id="isi">
<div id="forminput">
<form action="cpelanggan.php" method="POST" name="input">
<center><table>
...
<tr>
<td>No KTP</td><td>:</td><td><input type="text" name="No_KTP" placeholder="No KTP" class="box"></td>
</tr>
<tr>
<td>Nama</td><td>:</td><td><input type="text" name="Nama_Pelanggan" placeholder="Nama" class="box"></td>
</tr>
<tr>
<td>Alamat</td><td>:</td><td><input type="text" name="Alamat_Pelanggan" placeholder="Alamat" class="box"></td>
</tr>
<tr>
<td>No Telepon</td><td>:</td><td><input type="text" name="Telp_Pelanggan" placeholder="No Telepon" class="box"></td>
</tr>
</table></center>
</form>
