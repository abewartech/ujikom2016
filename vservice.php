...
<thead>
    ...
    echo"<tr>
            <td>$r[KodeService]</td>
            <td>$r[TglService]</td>
			<td>$r[BiayaService]</td>
			<td><a href='dservice.php?KodeService=".$r['KodeService']."' class='delete'>Hapus |<a/>
			<a href='eservice.php?KodeService=".$r['KodeService']."' class='delete'>Edit<a/>
			</td>
        </tr>";
		$no++;	
	}
