...
<caption>Data Setoran</caption>
<thead>
                        <tr>
                          	<th width="20%">No Setoran</th>
							<th>Kode Pemilik</th>
                            <th>Tgl Setoran</th>
							<th>Jumlah</th>
							<th>Option</th>
    ...
    echo"<tr>
            ...
            <td>$r[Tgl_Setoran]</td>
			<td>$r[Jumlah]</td>
			<td><a href='dsetoran.php?No_Setoran=".$r['No_Setoran']."'>Hapus |</a>
			<a href='esetoran.php?No_Setoran=".$r['No_Setoran']."'>Edit |</a>
			<a href='psetoran.php'>Cetak</a>
			</td>
        </tr>";
		$no++;	
	}
