...
<thead>
					...
					<?php
	include'koneksi.php';
    $query = mysql_query("select * from tb_transaksi_pinjam");
    ...
    echo"<tr>
			...
			<td>$r[Tgl_Pesan]</td>
            <td>$r[Tgl_Pinjam]</td>
            <td>$r[Tgl_Kembali_Rencana]</td>
            <td>$r[KM_Pinjam]</td>
			<td>$r[BBM_Pinjam]</td>
            <td>$r[Kondisi_Mobil_Pinjam]</td>
			<td><a href='dtransaksip.php?No_Transaksi=".$r['No_Transaksi']."' class='delete'>Hapus |<a/>
			<a href='etransaksip.php?No_Transaksi=".$r['No_Transaksi']."' class='delete'>Edit<a/>
			</td>
        </tr>";
		$no++;	
	}
